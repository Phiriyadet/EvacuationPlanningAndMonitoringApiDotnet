...
namespace Evacuation.UnitTests.Controllers.V2
{
    public class ZoneControllerTests
    {
        ...
        public ZoneControllerTests()
        {
            ...
            _mockServiceFactory
                .Setup(f => f.CreateZoneService(DatabaseType.Postgres))
                .Returns(_mockZoneService.Object);

            // สร้าง controller โดยส่ง factory mock เข้าไป
            _controller = new ZonesController(_mockServiceFactory.Object);
        }
            ...
            var zones = new List<ZoneDto>
        {
            ...
            _mockZoneService.Setup(s => s.GetAllZonesAsync())
        ...
        public async Task GetById_ReturnsOk_WhenZoneExists()
        {
            ...
            _mockZoneService.Setup(s => s.GetZoneByIdAsync(1))
        ...
        {
            // Arrange
            _mockZoneService.Setup(s => s.GetZoneByIdAsync(99))
        ...
        public async Task Post_ReturnsCreated_WhenSuccessful()
        {
            ...
            _mockZoneService.Setup(s => s.AddZoneAsync(createDto))
        ...
        public async Task Put_ReturnsOk_WhenSuccessful()
        {
            ...
            _mockZoneService.Setup(s => s.UpdateZoneAsync(1, updateDto))
                .ReturnsAsync(OperationResult<ZoneDto>.Ok(zoneDto));
        ...
        {
            // Arrange
            _mockZoneService.Setup(s => s.DeleteZoneAsync(1))
        ...
        {
            // Arrange
            _mockZoneService.Setup(s => s.DeleteZoneAsync(99))
