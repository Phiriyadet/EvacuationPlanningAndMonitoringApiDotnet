using Evacuation.API.Controllers.V2;
...
namespace Evacuation.UnitTests.Controllers.V2
{
    public class VehicleControllerTests
    {
        ...
        {
            // Mock ทั้ง factory และ vehicle service
            _mockServiceFactory = new Mock<IServiceFactory>();
            _mockVehicleService = new Mock<IVehicleService>();

            // กำหนดให้ factory.Return mock service เมื่อมีการเรียก CreateVehicleService
            _mockServiceFactory
                .Setup(f => f.CreateVehicleService(DatabaseType.Postgres))
                .Returns(_mockVehicleService.Object);

            // สร้าง controller โดยส่ง factory mock เข้าไป
            _controller = new VehiclesController(_mockServiceFactory.Object);
        }
        ...
        public async Task GetById_ReturnsOk_WhenVehicleExists()
        {
            ...
            _mockVehicleService.Setup(s => s.GetVehicleByIdAsync(1))
        ...
        {
            // Arrange
            _mockVehicleService.Setup(s => s.GetVehicleByIdAsync(99))
        ...
        public async Task Post_ReturnsCreated_WhenSuccessful()
        {
            ...
            _mockVehicleService.Setup(s => s.AddVehicleAsync(createDto))
        ...
        public async Task Put_ReturnsOk_WhenSuccessful()
        {
            ...
            _mockVehicleService.Setup(s => s.UpdateVehicleAsync(1, updateDto))
                .ReturnsAsync(OperationResult<VehicleDto>.Ok(vehicleDto));
        ...
        {
            // Arrange
            _mockVehicleService.Setup(s => s.DeleteVehicleAsync(1))
        ...
        {
            // Arrange
            _mockVehicleService.Setup(s => s.DeleteVehicleAsync(99))
